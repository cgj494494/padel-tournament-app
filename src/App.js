...
import PlayerManagementComponent from './components/PlayerManagementComponent';
import './index.css';
      ...
      <div className="App min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto p-4">
          <Routes>
            ...
            <Route path="/players" element={<PlayerManagementComponent saveLastUsed={saveLastUsedItem} />} />
