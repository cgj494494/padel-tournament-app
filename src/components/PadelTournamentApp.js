          ...
          {viewMode === 'input' && (
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                  ...
                  <div className="flex justify-between items-center mb-3">
                    <div>
                      ...
                      <div className="text-base mt-1">
                        Games: <span className="font-semibold text-lg">{getGames(1, 'A')}</span>
                        {getScore(1, 'A') !== '-' &&
                          <span className="ml-3">
                            Current: <span className="font-semibold text-lg">{getScore(1, 'A')}</span>
                          </span>
                        }
                      </div>
                    </div>
                    <div className="px-4 py-2 bg-blue-100 text-blue-800 font-bold text-lg rounded-lg border border-blue-200 shadow-sm">
                    ...
                    {inputMode === 'games' ? (
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {tennisScores.map((value) => (
                          <button
                            key={value}
                            className={`w-14 h-14 rounded-full font-bold text-xl flex items-center justify-center shadow-md ${currentMatch.court1.scoreA === value
                              ? 'bg-blue-600 text-white ring-2 ring-blue-300'
                              : 'bg-white text-gray-800 hover:bg-blue-50 border border-gray-200'
                              }`}
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-3">
                    <div>
                      ...
                      <div className="text-base mt-1">
                        Games: <span className="font-semibold text-lg">{getGames(1, 'B')}</span>
                        {getScore(1, 'B') !== '-' &&
                          <span className="ml-3">
                            Current: <span className="font-semibold text-lg">{getScore(1, 'B')}</span>
                          </span>
                        }
                      </div>
                    </div>
                    ...
                    {inputMode === 'games' ? (
                      <div className="grid grid-cols-4 gap-3">
                        {[0, 1, 2, 3, 4, 5, 6].map((value) => (
                          <button
                            key={value}
                            className={`w-14 h-14 rounded-full font-bold text-xl flex items-center justify-center shadow-md ${currentMatch.court1.gamesB === value
                              ? 'bg-blue-600 text-white ring-2 ring-blue-300'
                              : 'bg-white text-gray-800 hover:bg-blue-50 border border-gray-200'
                              }`}
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {tennisScores.map((value) => (
                          <button
                            key={value}
                            className={`w-14 h-14 rounded-full font-bold text-xl flex items-center justify-center shadow-md ${currentMatch.court1.scoreB === value
                              ? 'bg-blue-600 text-white ring-2 ring-blue-300'
                              : 'bg-white text-gray-800 hover:bg-blue-50 border border-gray-200'
                              }`}
              ...
              <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200 overflow-hidden">
                ...
                {/* Team A */}
                <div className="p-4"><div className="flex justify-between items-center mb-3">
                  <div>
                    <div className="font-bold text-xl">
                      {getTeamName(2, 'A')}
                    </div>
                    <div className="text-base mt-1">
                      Games: <span className="font-semibold text-lg">{getGames(2, 'A')}</span>
                      {getScore(2, 'A') !== '-' &&
                        <span className="ml-3">
                          Current: <span className="font-semibold text-lg">{getScore(2, 'A')}</span>
                        </span>
                      }
                    </div>
                  </div>
                    ...
                    {inputMode === 'games' ? (
                      <div className="grid grid-cols-4 gap-3">
                        {[0, 1, 2, 3, 4, 5, 6].map((value) => (
                          <button
                            key={value}
                            className={`w-14 h-14 rounded-full font-bold text-xl flex items-center justify-center shadow-md ${currentMatch.court2.gamesA === value
                              ? 'bg-blue-600 text-white ring-2 ring-blue-300'
                              : 'bg-white text-gray-800 hover:bg-blue-50 border border-gray-200'
                              }`}
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {tennisScores.map((value) => (
                          <button
                            key={value}
                            className={`w-14 h-14 rounded-full font-bold text-xl flex items-center justify-center shadow-md ${currentMatch.court2.scoreA === value
                              ? 'bg-blue-600 text-white ring-2 ring-blue-300'
                              : 'bg-white text-gray-800 hover:bg-blue-50 border border-gray-200'
                              }`}
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-3">
                    <div>
                      ...
                      <div className="text-base mt-1">
                        Games: <span className="font-semibold text-lg">{getGames(2, 'B')}</span>
                        {getScore(2, 'B') !== '-' &&
                          <span className="ml-3">
                            Current: <span className="font-semibold text-lg">{getScore(2, 'B')}</span>
                          </span>
                        }
                      </div>
                    </div>
                    ...
                    {inputMode === 'games' ? (
                      <div className="grid grid-cols-4 gap-3">
                        {[0, 1, 2, 3, 4, 5, 6].map((value) => (
                          <button
                            key={value}
                            className={`w-14 h-14 rounded-full font-bold text-xl flex items-center justify-center shadow-md ${currentMatch.court2.gamesB === value
                              ? 'bg-blue-600 text-white ring-2 ring-blue-300'
                              : 'bg-white text-gray-800 hover:bg-blue-50 border border-gray-200'
                              }`}
